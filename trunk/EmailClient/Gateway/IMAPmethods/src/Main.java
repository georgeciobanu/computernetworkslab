	    ...
	    Login();
	      ...
	      */ 
	      ...
	      /*  // TEST for ListOfEmails AND getTHEamil methods
	        ...
	        System.out.print("\nBody:\n"+fullFoo.getBody());
	      */  
	       // System.out.println("recent b4 setting ="+foo.getFldRecentMsg());
	       // System.out.println(fooRecent);
	       // foo.setFldRecentMsg(fooRecent);
	       // System.out.println("recent after setting ="+foo.getFldRecentMsg());
	        //System.out.println(" NAME: "+foo.getFldName());
	        //System.out.println(" REC: "+foo.getFldRecentMsg());
	        //System.out.println(" TOT: "+foo.getFldTotalMsg());
	        //System.out.println(" UN: "+foo.getFldUnseenMsg());
	        //System.out.println(NumberOfEmail("MESSAGES","INBOX.Sent Items"));
	       // foo.setFldTotalMsg(NumberOfEmail("MESSAGES","INBOX"));
	       // System.out.println(" Recent emails: "+foo.getFldTotalMsg());
	        	
	       // Folders[] folderlist = GetFoldersInfo();
	       // print(folderlist[0].FolderName);
      //  }
